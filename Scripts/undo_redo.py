...
# v1.6: asset-name -> Ursina-object resolution relocated to Scripts/asset_resolve.py
# (save/load, spawn and the pickers need it too — it was never command-specific).
# Imported under the old private names so the command bodies below are unchanged.
